...
public class Subscription extends Base {
    ...
    By subscriptionText = By.xpath("//label[@for='subscribeEmail']");
    By subscriptionButton = By.xpath("//span[text()='Подписаться']");
    By subscriptionMail = By.id("subscribeEmail");
    By successfulSubscriptionText = By.xpath("//div[@class='subscription-block__success-message']/p");
    By failedSubscriptionText = By.xpath("//p[@class='message message_error']");
